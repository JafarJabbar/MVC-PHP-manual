...
<section class="jumbotron text-center">
    <div class="container">
        ...
        <div class="breadcrumb-custom">
            ...
            <a href="<?=site_url('blog')?>" >Etiketlər</a>
            <a href="" class="active">/<?=$tag['tag_name']?>
            </a>
        </div>
    </div>
</section>
        ...
        <div class="col-md-8">
            ...
            <?php else:?>
                    <div class="alert alert-warning">
                        <?=$tag['tag_name']?> etiketi ilə bağlı heç bir post yüklənməmişdir...
                    </div>
            <?php endif; ?>
         ...
         <?php if ($totalRecord>$pageLimit): ?>
             <div class="pagination-container text-center mb-4">
                 <nav aria-label="Page navigation example">
                     <ul class="pagination">
                         <li class="page-item">
                             <a class="page-link" href="<?=site_url("blog/tags/$tag_url?$pageParam=".$db->prevPage())?>" aria-label="Previous">
                                 <span aria-hidden="true">«</span>
                                 <span class="sr-only">Əvvəlki</span>
                             </a>
                         </li>
                         <?= $db->showPagination(site_url("blog/tags/$tag_url?$pageParam=[page]"),'active',true) ?>
                         <li class="page-item">
                             <a class="page-link" href="<?=site_url("blog/tags/$tag_url?$pageParam=".$db->nextPage() )?>" aria-label="Next">
                                 <span aria-hidden="true">»</span>
