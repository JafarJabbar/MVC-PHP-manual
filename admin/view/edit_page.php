                     ...
                     <ul>
                         <li>
                             ...
                             <div class="form-content">
                                 <input type="text" value="<?= post("page_name")?post("page_name"):$query['page_name']; ?>" name="page_name">
                             </div>
                         </li>
                         <li>
                             <label>Səhifə contenti</label>
                             <div class="form-content">
                                <textarea name="page_content" class="editor" cols="30" rows="5">
                                   <?= post("page_content")?post("page_content"):$query['page_content']; ?>
                                </textarea>
                             </div>
                         </li>
                 ...
                 <div tab-content>
                     <ul>
                         <li>
                             ...
                             <div class="form-content">
                                 <input type="text" value="<?= post("page_url")?post("page_url"):$query['page_url']; ?>"
                                        name="page_url">
