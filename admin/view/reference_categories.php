    ...
    <div class="box-">
        <h1>
            ...
            <?php if (permission('reference_categories','add')):?>
                ...
                <a  href="<?= admin_url('add_reference_category') ?>">Yeni kateqoriya </a>
            <?php endif; ?>
        </h1>
            ...
            <tr>
                ...
                <td>
                    <?php if ( permission('users', 'edit') ): ?>
                        <a href="edit_reference_category?category_id=<?= $category['category_id'] ?>" class="btn">Dəyiş</a>
                    <?php endif; ?>
                    <?php if (permission('users', 'delete')): ?>
                    <a onclick="return confirm('Silmək istədiyinizdən əminsiniz?')"
                       href="delete?table=reference_categories&column=category_id&id=<?= $category['category_id'] ?>" class="btn">Sil</a>
                    <?php endif; ?>
                </td>
